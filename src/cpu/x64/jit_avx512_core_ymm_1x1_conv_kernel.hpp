...
#ifndef CPU_X64_JIT_AVX512_CORE_YMM_1X1_CONV_KERNEL_HPP
#define CPU_X64_JIT_AVX512_CORE_YMM_1X1_CONV_KERNEL_HPP
...
struct jit_avx512_core_ymm_1x1_conv_kernel : public jit_generator {
    jit_avx512_core_ymm_1x1_conv_kernel(const jit_1x1_conv_conf_t &ajcp,
            const primitive_attr_t &attr, const memory_desc_t &dst_md);

    ~jit_avx512_core_ymm_1x1_conv_kernel() {
    ...
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx512_core_ymm_1x1_conv_kernel)
...
private:
    ...
    Xbyak::Ymm vreg_bcast = Xbyak::Ymm(31);
    ...
    nstl::vector<jit_uni_eltwise_injector_f32<avx512_common, Xbyak::Ymm>*> eltwise_injectors;
    nstl::vector<jit_uni_depthwise_injector_f32<avx512_common, Xbyak::Ymm>*> depthwise_injectors;
    nstl::vector<jit_uni_quantization_injector_f32<avx512_common, Xbyak::Ymm>*> quantization_injectors;
