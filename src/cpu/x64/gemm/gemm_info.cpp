...
void gemm_info_t<a_t, b_t, c_t>::jit_init(void) {
    ...
    std::call_once(initialized, [&, um] {
        using jit_generator_ptr = std::unique_ptr<jit_generator>;
        ...
        static jit_generator_ptr copy_a[2][2] = {{nullptr}};
        static jit_generator_ptr copy_b[2][2] = {{nullptr}};
        ...
        switch (data_traits<a_t>::data_type) {
                ...
                if (mayiuse(amx_int8)) {
                    for (int isTrans : {no_trans, do_trans}) {
                        copy_a[isTrans][no_sum]
                                = jit_generator_ptr(new jit_avx512_core_amx_copy_kern(
                    ...
                    copy_a[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_u8_copy_an_kern());
                    copy_a[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_u8_copy_at_kern());

                    copy_b[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_u8_copy_bn_kern(b_is_s8));
                    copy_b[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_u8_copy_bt_kern(b_is_s8));

                    copy_a[no_trans][do_sum]
                            = jit_generator_ptr(new jit_avx512_core_u8_copy_sum_an_kern());
                    copy_a[do_trans][do_sum]
                            = jit_generator_ptr(new jit_avx512_core_u8_copy_sum_at_kern());

                    copy_b[no_trans][do_sum]
                            = jit_generator_ptr(new jit_avx512_core_u8_copy_sum_bn_kern(b_is_s8));
                    copy_b[do_trans][do_sum]
                            = jit_generator_ptr(new jit_avx512_core_u8_copy_sum_bt_kern(b_is_s8));
                } else if (mayiuse(avx2_vnni)) {
                    copy_a[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx2_vnni_u8_copy_an_kern());
                    copy_a[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx2_vnni_u8_copy_at_kern());

                    copy_b[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx2_vnni_u8_copy_bn_kern());
                    copy_b[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx2_vnni_u8_copy_bt_kern());

                    copy_a[no_trans][do_sum]
                            = jit_generator_ptr(new jit_avx2_vnni_u8_copy_sum_an_kern());
                    copy_a[do_trans][do_sum]
                            = jit_generator_ptr(new jit_avx2_vnni_u8_copy_sum_at_kern());

                    copy_b[no_trans][do_sum]
                            = jit_generator_ptr(new jit_avx2_vnni_u8_copy_sum_bn_kern());
                    copy_b[do_trans][do_sum]
                            = jit_generator_ptr(new jit_avx2_vnni_u8_copy_sum_bt_kern());
                } else if (mayiuse(avx2)) {
                    copy_a[no_trans][no_sum] = jit_generator_ptr(new jit_avx2_u8_copy_an_kern());
                    copy_a[do_trans][no_sum] = jit_generator_ptr(new jit_avx2_u8_copy_at_kern());

                    copy_b[no_trans][no_sum] = jit_generator_ptr(new jit_avx2_u8_copy_bn_kern());
                    copy_b[do_trans][no_sum] = jit_generator_ptr(new jit_avx2_u8_copy_bt_kern());

                    copy_a[no_trans][do_sum]
                            = jit_generator_ptr(new jit_avx2_u8_copy_sum_an_kern());
                    copy_a[do_trans][do_sum]
                            = jit_generator_ptr(new jit_avx2_u8_copy_sum_at_kern());

                    copy_b[no_trans][do_sum]
                            = jit_generator_ptr(new jit_avx2_u8_copy_sum_bn_kern());
                    copy_b[do_trans][do_sum]
                            = jit_generator_ptr(new jit_avx2_u8_copy_sum_bt_kern());
                } else if (mayiuse(avx)) {
                    copy_a[no_trans][no_sum] = jit_generator_ptr(new jit_avx_u8_copy_an_kern());
                    copy_a[do_trans][no_sum] = jit_generator_ptr(new jit_avx_u8_copy_at_kern());

                    copy_b[no_trans][no_sum] = jit_generator_ptr(new jit_avx_u8_copy_bn_kern());
                    copy_b[do_trans][no_sum] = jit_generator_ptr(new jit_avx_u8_copy_bt_kern());

                    copy_a[no_trans][do_sum]
                            = jit_generator_ptr(new jit_avx_u8_copy_sum_an_kern());
                    copy_a[do_trans][do_sum]
                            = jit_generator_ptr(new jit_avx_u8_copy_sum_at_kern());

                    copy_b[no_trans][do_sum]
                            = jit_generator_ptr(new jit_avx_u8_copy_sum_bn_kern());
                    copy_b[do_trans][do_sum]
                            = jit_generator_ptr(new jit_avx_u8_copy_sum_bt_kern());
                } else if (mayiuse(sse41)) {
                    copy_a[no_trans][no_sum] = jit_generator_ptr(new jit_sse41_u8_copy_an_kern());
                    copy_a[do_trans][no_sum] = jit_generator_ptr(new jit_sse41_u8_copy_at_kern());

                    copy_b[no_trans][no_sum] = jit_generator_ptr(new jit_sse41_u8_copy_bn_kern());
                    copy_b[do_trans][no_sum] = jit_generator_ptr(new jit_sse41_u8_copy_bt_kern());

                    copy_a[no_trans][do_sum]
                            = jit_generator_ptr(new jit_sse41_u8_copy_sum_an_kern());
                    copy_a[do_trans][do_sum]
                            = jit_generator_ptr(new jit_sse41_u8_copy_sum_at_kern());

                    copy_b[no_trans][do_sum]
                            = jit_generator_ptr(new jit_sse41_u8_copy_sum_bn_kern());
                    copy_b[do_trans][do_sum]
                            = jit_generator_ptr(new jit_sse41_u8_copy_sum_bt_kern());
                }
                break;
            ...
            case data_type::bf16:
                if (mayiuse(amx_bf16)) {
                    ...
                    copy_a[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_s16_48x8_copy_an_kern());
                    copy_a[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_s16_48x8_copy_at_kern());

                    copy_b[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_s16_48x8_copy_bn_kern());
                    copy_b[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_s16_48x8_copy_bt_kern());
                } else if (mayiuse(avx512_core) && use_bf16_ymm) {
                    copy_a[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_s16_24x8_copy_an_kern());
                    copy_a[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_s16_24x8_copy_at_kern());

                    copy_b[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_s16_24x8_copy_bn_kern());
                    copy_b[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_s16_24x8_copy_bt_kern());
                }
                break;
            ...
            case data_type::f32:
                if (mayiuse(avx512_core)) {
                    copy_a[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_f32_copy_an_kern());
                    copy_a[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_f32_copy_at_kern());

                    copy_b[no_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_f32_copy_bn_kern());
                    copy_b[do_trans][no_sum]
                            = jit_generator_ptr(new jit_avx512_core_f32_copy_bt_kern());
                } else if (mayiuse(avx2)) {
                    copy_a[no_trans][no_sum] = jit_generator_ptr(new jit_avx2_f32_copy_an_kern());
                    copy_a[do_trans][no_sum] = jit_generator_ptr(new jit_avx2_f32_copy_at_kern());

                    copy_b[no_trans][no_sum] = jit_generator_ptr(new jit_avx2_f32_copy_bn_kern());
                    copy_b[do_trans][no_sum] = jit_generator_ptr(new jit_avx2_f32_copy_bt_kern());
                } else if (mayiuse(avx)) {
                    copy_a[no_trans][no_sum] = jit_generator_ptr(new jit_avx_f32_copy_an_kern());
                    copy_a[do_trans][no_sum] = jit_generator_ptr(new jit_avx_f32_copy_at_kern());

                    copy_b[no_trans][no_sum] = jit_generator_ptr(new jit_avx_f32_copy_bn_kern());
                    copy_b[do_trans][no_sum] = jit_generator_ptr(new jit_avx_f32_copy_bt_kern());
                } else if (mayiuse(sse41)) {
                    copy_a[no_trans][no_sum] = jit_generator_ptr(new jit_sse41_f32_copy_an_kern());
                    copy_a[do_trans][no_sum] = jit_generator_ptr(new jit_sse41_f32_copy_at_kern());

                    copy_b[no_trans][no_sum] = jit_generator_ptr(new jit_sse41_f32_copy_bn_kern());
                    copy_b[do_trans][no_sum] = jit_generator_ptr(new jit_sse41_f32_copy_bt_kern());
                }
                break;
        ...
        static jit_generator_ptr kernel[2][2][2][2] = {{{{nullptr}}}};
        switch (data_traits<a_t>::data_type) {
            case data_type::s8:
                if (mayiuse(avx512_core_bf16_amx_int8)) {
                    for (int isBeta0 : {no_beta0, do_beta0}) {
                        kernel[isBeta0][do_alpha1][no_sum][no_sum]
                                = jit_generator_ptr(new jit_avx512_core_amx_gemm_kern(
                        ...
                        for (int doColSum : {no_sum, do_sum})
                            for (int doRowSum : {no_sum, do_sum}) {
                                kernel[isBeta0][do_alpha1][doColSum][doRowSum]
                                        = jit_generator_ptr(new jit_avx512_core_gemm_s8u8s32_kern(
                    ...
                    for (int isBeta0 : {no_beta0, do_beta0})
                        for (int doColSum : {no_sum, do_sum})
                            for (int doRowSum : {no_sum, do_sum}) {
                                kernel[isBeta0][do_alpha1][doColSum][doRowSum]
                                        = jit_generator_ptr(new jit_avx2_gemm_s8u8s32_kern(
                                                isBeta0, doColSum, doRowSum,
                                                um));
                            }
                } else if (mayiuse(avx)) {
                    kernel[no_beta0][do_alpha1][no_sum][no_sum]
                            = jit_generator_ptr(new jit_avx_kernel_gemm_s8u8s32_kern());
                    kernel[no_beta0][do_alpha1][do_sum][no_sum]
                            = jit_generator_ptr(new jit_avx_kernel_c_gemm_s8u8s32_kern());
                    kernel[no_beta0][do_alpha1][no_sum][do_sum]
                            = jit_generator_ptr(new jit_avx_kernel_r_gemm_s8u8s32_kern());
                    kernel[no_beta0][do_alpha1][do_sum][do_sum]
                            = jit_generator_ptr(new jit_avx_kernel_b_gemm_s8u8s32_kern());

                    kernel[do_beta0][do_alpha1][no_sum][no_sum]
                            = jit_generator_ptr(new jit_avx_kernel_b0_gemm_s8u8s32_kern());
                    kernel[do_beta0][do_alpha1][do_sum][no_sum]
                            = jit_generator_ptr(new jit_avx_kernel_b0_c_gemm_s8u8s32_kern());
                    kernel[do_beta0][do_alpha1][no_sum][do_sum]
                            = jit_generator_ptr(new jit_avx_kernel_b0_r_gemm_s8u8s32_kern());
                    kernel[do_beta0][do_alpha1][do_sum][do_sum]
                            = jit_generator_ptr(new jit_avx_kernel_b0_b_gemm_s8u8s32_kern());
                } else if (mayiuse(sse41)) {
                    kernel[no_beta0][do_alpha1][no_sum][no_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_gemm_s8u8s32_kern());
                    kernel[no_beta0][do_alpha1][do_sum][no_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_c_gemm_s8u8s32_kern());
                    kernel[no_beta0][do_alpha1][no_sum][do_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_r_gemm_s8u8s32_kern());
                    kernel[no_beta0][do_alpha1][do_sum][do_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_b_gemm_s8u8s32_kern());

                    kernel[do_beta0][do_alpha1][no_sum][no_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_b0_gemm_s8u8s32_kern());
                    kernel[do_beta0][do_alpha1][do_sum][no_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_b0_c_gemm_s8u8s32_kern());
                    kernel[do_beta0][do_alpha1][no_sum][do_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_b0_r_gemm_s8u8s32_kern());
                    kernel[do_beta0][do_alpha1][do_sum][do_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_b0_b_gemm_s8u8s32_kern());
                }
                break;
                    ...
                    for (int isBeta0 : {no_beta0, do_beta0})
                        for (int isAlpha1 : {no_alpha1, do_alpha1}) {
                            kernel[isBeta0][isAlpha1][no_sum][no_sum]
                                    = jit_generator_ptr(new jit_avx512_core_gemm_bf16bf16f32_kern(
            ...
            case data_type::f32:
                if (mayiuse(avx2)) {
                    for (int isBeta0 : {no_beta0, do_beta0}) {
                        kernel[isBeta0][do_alpha1][no_sum][no_sum]
                                = jit_generator_ptr(new jit_avx2_kernel_sgemm_kern(isBeta0));
                    }
                } else if (mayiuse(avx)) {
                    kernel[no_beta0][do_alpha1][no_sum][no_sum]
                            = jit_generator_ptr(new jit_avx_kernel_sgemm_kern);
                    kernel[do_beta0][do_alpha1][no_sum][no_sum]
                            = jit_generator_ptr(new jit_avx_kernel_b0_sgemm_kern());
                } else if (mayiuse(sse41)) {
                    kernel[no_beta0][do_alpha1][no_sum][no_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_sgemm_kern);
                    kernel[do_beta0][do_alpha1][no_sum][no_sum]
                            = jit_generator_ptr(new jit_sse41_kernel_b0_sgemm_kern());
                }
                break;
        ...
        static jit_generator_ptr gemv_kernel[2] = {nullptr};
        static jit_generator_ptr gemv_s8s8s32_kernel = nullptr;
        static jit_generator_ptr gemv_s8u8s32_kernel = nullptr;
        static jit_generator_ptr gemv_u8s8s32_kernel = nullptr;
        switch (data_traits<a_t>::data_type) {
            case data_type::s8:
                if (mayiuse(avx512_core)) {
                    gemv_s8s8s32_kernel = jit_generator_ptr(new jit_avx512_core_gemv_s8x8s32_kern(
                            ver_t::s8s8));
                    gemv_s8u8s32_kernel = jit_generator_ptr(new jit_avx512_core_gemv_s8x8s32_kern(
                            ver_t::s8u8));
                    gemv_u8s8s32_kernel = jit_generator_ptr(new jit_avx512_core_gemv_s8x8s32_kern(
                            ver_t::u8s8));
                }
                break;
            ...
            case data_type::bf16:
                if (mayiuse(avx512_core)) {
                    for (int isTrans : {no_trans, do_trans})
                        gemv_kernel[isTrans]
                                = jit_generator_ptr(new jit_avx512_core_gemv_bf16bf16f32_kern(
                                        isTrans));
                }
                break;
            ...
            case data_type::f32:
                if (mayiuse(avx)) {
                    gemv_kernel[no_trans] = jit_generator_ptr(new jit_sse41_gemv_n_f32_kern());
                    gemv_kernel[do_trans] = jit_generator_ptr(new jit_avx_gemv_t_f32_kern());
                } else if (mayiuse(sse41)) {
                    gemv_kernel[no_trans] = jit_generator_ptr(new jit_sse41_gemv_n_f32_kern());
                    gemv_kernel[do_trans] = jit_generator_ptr(new jit_sse41_gemv_t_f32_kern());
                }
                break;
        }
        ...
        for (int isBeta0 : {no_beta0, do_beta0})
            for (int isAlpha1 : {no_alpha1, do_alpha1})
                for (int doColSum : {no_sum, do_sum})
                    for (int doRowSum : {no_sum, do_sum}) {
                        auto *p_kernel
                                = kernel[isBeta0][isAlpha1][doColSum][doRowSum].get();
                        if (p_kernel != nullptr) {
