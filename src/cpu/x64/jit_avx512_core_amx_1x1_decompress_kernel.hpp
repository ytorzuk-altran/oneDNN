...
#ifndef CPU_X64_JIT_AVX512_CORE_AMX_1x1_DECOMPRESS_KERNEL_HPP
#define CPU_X64_JIT_AVX512_CORE_AMX_1x1_DECOMPRESS_KERNEL_HPP
...
struct jit_avx512_core_amx_1x1_decompress_kernel_t : public jit_generator {
    DECLARE_CPU_JIT_AUX_FUNCTIONS(jit_avx512_core_amx_1x1_decompress_kernel_t)
    jit_avx512_core_amx_1x1_decompress_kernel_t(jit_conv_conf_t ajsp)
        : jcp(ajsp) {}

    ~jit_avx512_core_amx_1x1_decompress_kernel_t() {}
