...
#define INSTANCE_1(name) primitive_desc_builder<name::pd_t>(MKLDNN_MACRO_TOSTRING(name))
#define INSTANCE_2(name, arg1) primitive_desc_builder<name<arg1>::pd_t>(MKLDNN_MACRO_TOSTRING(name ## _ ## arg1))
#define INSTANCE_3(name, arg1, arg2) primitive_desc_builder<name<arg1, arg2>::pd_t>(MKLDNN_MACRO_TOSTRING(name ## _ ## arg1 ## _ ## arg2))
#define INSTANCE_4(name, arg1, arg2, arg3) primitive_desc_builder<name<arg1, arg2, arg3>::pd_t>(MKLDNN_MACRO_TOSTRING(name ## _ ## arg1 ## _ ## arg2 ## _ ## arg3))
...
mkldnn::impl::status_t primitive_builder_stub(
        mkldnn::impl::primitive_desc_t **,
        const mkldnn::impl::op_desc_t *,
        const mkldnn::impl::primitive_attr_t *,
        mkldnn::impl::engine_t *,
...
#define INSTANCE_BUILDER_1(...) __VA_ARGS__
#define INSTANCE_BUILDER(name, ...) MKLDNN_MACRO_EXPAND(MKLDNN_MACRO_CAT(INSTANCE_BUILDER_, MKLDNN_MACRO_IS_ENABLED(MKLDNN_MACRO_CAT(MKLDNN_, name)))(__VA_ARGS__))

#define INSTANCE(...) MKLDNN_MACRO_OVERLOAD(INSTANCE, __VA_ARGS__)
#define INSTANCE_1(name) INSTANCE_BUILDER(name, &primitive_desc_t::create<name::pd_t>)
#define INSTANCE_2(name, arg1) INSTANCE_BUILDER(name ## _ ## arg1, &primitive_desc_t::create<name<arg1>::pd_t>)
#define INSTANCE_3(name, arg1, arg2) INSTANCE_BUILDER(name ## _ ## arg1 ## _ ## arg2, &primitive_desc_t::create<name<arg1, arg2>::pd_t>)
#define INSTANCE_4(name, arg1, arg2, arg3) INSTANCE_BUILDER(name ## _ ## arg1 ## _ ## arg2 ## _ ## arg3, &primitive_desc_t::create<name<arg1, arg2, arg3>::pd_t>)
#define INSTANCE_5(name, arg1, arg2, arg3, arg4) INSTANCE_BUILDER(name ## _ ## arg1 ## _ ## arg2 ## _ ## arg3 ## _ ## arg4, &primitive_desc_t::create<name<arg1, arg2, arg3, arg4>::pd_t>)
